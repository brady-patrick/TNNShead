...
import { Bell01, LifeBuoy01, SearchLg, Settings01, Home01, Users01, BookOpen01, Calendar } from "@untitledui/icons";
...
interface SportsNavigationBaseProps {
...
export const SportsNavigationBase = ({
    activeUrl,
    items = [],
    subItems,
    trailingContent,
...
export const SportsNavigation = ({ activeUrl }: { activeUrl?: string }) => {
    const defaultItems: NavItem[] = [
        ...
        { 
            ...
            href: "/players", 
            icon: Users01,
            current: activeUrl === "/players",
            items: [
                { label: "Roster", href: "/players/roster", current: activeUrl === "/players/roster" },
                { label: "Statistics", href: "/players/stats", current: activeUrl === "/players/stats" },
                { label: "Performance", href: "/players/performance", current: activeUrl === "/players/performance" },
                { label: "Injuries", href: "/players/injuries", current: activeUrl === "/players/injuries" },
            ]
        },
        { 
            label: "Coaching", 
            href: "/coaching", 
            icon: BookOpen01,
            current: activeUrl === "/coaching",
            items: [
                { label: "Staff", href: "/coaching/staff", current: activeUrl === "/coaching/staff" },
                { label: "Training Plans", href: "/coaching/training", current: activeUrl === "/coaching/training" },
                { label: "Drills", href: "/coaching/drills", current: activeUrl === "/coaching/drills" },
                { label: "Strategy", href: "/coaching/strategy", current: activeUrl === "/coaching/strategy" },
            ]
        },
        { 
            label: "Events", 
            href: "/events", 
            icon: Calendar,
            current: activeUrl === "/events",
            items: [
                { label: "Games", href: "/events/games", current: activeUrl === "/events/games" },
                { label: "Practices", href: "/events/practices", current: activeUrl === "/events/practices" },
                { label: "Tournaments", href: "/events/tournaments", current: activeUrl === "/events/tournaments" },
                { label: "Schedule", href: "/events/schedule", current: activeUrl === "/events/schedule" },
            ]
        },
    ];
